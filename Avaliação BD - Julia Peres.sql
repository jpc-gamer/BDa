...
SELECT nome from piloto where nacionalidade = 'Brasil';

SELECT nome from piloto where nacionalidade = 'México';

SELECT nome from piloto where nacionalidade = 'Japão';

SELECT nome from piloto where nacionalidade = 'Estados Unidos';

select nome from piloto where nacionalidade = 'Inglaterra' and equipe = 'Mercedes';
